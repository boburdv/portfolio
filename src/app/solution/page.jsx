  ...
  return (
    <div className="mt-[10%] flex items-center justify-center px-4">
      <div className="flex flex-col sm:flex-row items-center gap-8 text-center sm:text-left">
        <img src="/bossbaby.png" className="w-[120px] sm:w-[150px] animate-slide-top delay-600" alt="bossbaby" />

        <div>
          <h2 className="text-5xl sm:text-7xl font-bold text-slate-500 mb-2 animate-slide-top delay-100">404</h2>
